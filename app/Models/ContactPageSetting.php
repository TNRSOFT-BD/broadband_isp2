...
class ContactPageSetting extends Model
{
    ...
    public static function getDefaults(): array
    {
        return [
            ...
            'helpful_resources' => [
                ['icon' => 'HelpCircle', 'title' => 'FAQs', 'description' => 'Find answers to commonly asked questions about our services.', 'href' => '#faq'],
                ['icon' => 'Wifi', 'title' => 'Internet Plans', 'description' => 'Explore our range of high-speed internet packages.', 'href' => '/plans'],
                ['icon' => 'MapPin', 'title' => 'Coverage Area', 'description' => 'Check if our service is available in your area.', 'href' => '#locations'],
                ['icon' => 'Headphones', 'title' => 'Support Center', 'description' => 'Get technical help and troubleshooting guides.', 'href' => '#'],
                ['icon' => 'CreditCard', 'title' => 'Billing Info', 'description' => 'Learn about payment methods and billing cycles.', 'href' => '#'],
                ['icon' => 'Wrench', 'title' => 'Installation', 'description' => 'Understand our installation process and requirements.', 'href' => '#'],
            ],
            'faq_items' => [
