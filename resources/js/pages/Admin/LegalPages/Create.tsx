...
export default function LegalPageCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: adminUrl('/legal-pages/create') },
    ];
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        page_type: 'other',
        short_description: '',
        content_json: null as JSONContent | null,
        status: 'draft',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Legal Page" />

            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div>
                    <h1 className="text-2xl font-bold">Create Legal Page</h1>
                    <p className="text-muted-foreground">Create a new legal or policy page.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Write the main content using the rich text editor.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <TiptapEditor
